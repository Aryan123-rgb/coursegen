          ...
          {isPending ? (
            ...
            <div className="relative flex items-center gap-3">
              ...
              <button
                ...
                className="cursor-pointer flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 text-white hover:opacity-90 transition font-medium text-sm"
